...
<head>
	...
	<title>Medium Payment | AfricTv </title>
</head>
<body>

	<div>
		<h2>Medium Payment | AfricTv</h2>
		<form id="paymentForm">
	...
	function payWithPaystack(e) {
	  ...
	  let handler = PaystackPop.setup({
	    ...
	    callback: function(response){
	      ...
	      alert(message);
	      window.location = "http://localhost/africtvApi/auth/classes/verify_mediumpayment.classes.php?reference=" + response.reference;
	    }
	  });
